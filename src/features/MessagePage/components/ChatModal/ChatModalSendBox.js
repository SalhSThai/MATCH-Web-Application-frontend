...
export default function ChatModalSendBox(props) {
    ...
    console.log('SendBox',message);
    return (<form className='fixed bottom-0 left-0 right-0 min-h-[10%] bg-white flex justify-evenly items-center shadow-[4px_0_4px_4px_rgba(0,0,0,0.1)]  p-3 z-[1]' onSubmit={handleSubmit}>
